UTF16マルチフォントファイル(バイナリ) exfont.binについて

ドキュメント作成日 2016年4月18日
ドキュメント作成日 2016年4月19日

製作者      :たま吉さん
製作者HP    :http://nuneno.cocolog-nifty.com/blog/2015/02/arduinorom-a11f.html

exfont.binは7種類の日本語ビットマップフォントをバイナリファイル形式で格納した
フォントファイルです。下記のフォントを収録しています。
